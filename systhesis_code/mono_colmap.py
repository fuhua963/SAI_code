...
# 2000 1000 6472.86 6419.42 1000 500
    ...
    save_path =  os.dir.abspath(os.path.join(os.path.dirname(__file__), '..', 'results'))
    files_num = len(os.listdir(save_path))
    
    
    extrinsic_path = os.dir.abspath(os.path.join(os.path.dirname(__file__), '..', 'colmap_data'))
    extrinsic_files_list = os.listdir(extrinsic_path)
